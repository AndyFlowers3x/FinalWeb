...
import p1 from "../../img/productos.jpg";
import p2 from "../../img/productos.jpg";
import p3 from "../../img/productos.jpg";
import p4 from "../../img/productos.jpg";
import p5 from "../../img/productos.jpg";
import p6 from "../../img/productos.jpg";
import p7 from "../../img/productos.jpg";
import p8 from "../../img/productos.jpg";
import p9 from "../../img/productos.jpg";
...
const PRODUCTS = [
  {
    ...
    desc: "Tender pasta combined with a creamy Alfredo-style sauce and savory chicken flavor for a delicious and filling dish.",
    img: p1,
    tag: "💪 High Protein"
  },
  {
  ...
  },
  {
    id: 3,
    name: "Golden Pancake",
    desc: "Golden, light, and fluffy pancakes with a soft texture and delicious taste. Perfect for a quick and satisfying breakfast.",
    img: p3,
    tag: "⚡ Energy"
  },
  {
    ...
    desc: "Soft and fluffy pancakes filled with rich chocolate chips that melt as you cook, creating a comforting sweet breakfast.",
    img: p4,
    tag: "⚡ Energy"
  },
  {
  ...
  },
  {
    ...
    desc: "A refreshing fruit drink bursting with the sweet and sour flavors of mixed wild berries.",
    img: p7,
    tag: "⚡ Energy"
  },
  {
